...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "freeq_selectivity", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("freeq_selectivity")
        ...
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.channels_channel_model_2, 0))
        ...
        self.connect((self.channels_channel_model_2, 0), (self.digital_ofdm_rx_0, 0))
    ...
    def set_freq_offset(self, freq_offset):
        ...
        self.channels_channel_model_2.set_frequency_offset((self.freq_offset * 1.0/self.fft_len))
