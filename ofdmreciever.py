...
import ofdmreciever_epy_block_0 as epy_block_0  # embedded python block
import osmosdr
import time
...
class ofdmreciever(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdmreciever")
        ...
        self.qtgui_number_sink_0_0_0_1.set_title('average power recieved')
        ...
        self.osmosdr_source_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + 'rtl=0,buffers=128,buflen=32768'
        )
        self.osmosdr_source_0.set_time_now(osmosdr.time_spec_t(time.time()), osmosdr.ALL_MBOARDS)
        self.osmosdr_source_0.set_sample_rate(samp_rate)
        self.osmosdr_source_0.set_center_freq(7e8, 0)
        self.osmosdr_source_0.set_freq_corr(0, 0)
        self.osmosdr_source_0.set_dc_offset_mode(0, 0)
        self.osmosdr_source_0.set_iq_balance_mode(0, 0)
        self.osmosdr_source_0.set_gain_mode(False, 0)
        self.osmosdr_source_0.set_gain(100, 0)
        self.osmosdr_source_0.set_if_gain(200, 0)
        self.osmosdr_source_0.set_bb_gain(200, 0)
        ...
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
        ...
        self.connect((self.digital_ofdm_rx_0_0_0, 0), (self.blocks_uchar_to_float_0, 0))
        self.connect((self.epy_block_0, 0), (self.qtgui_number_sink_0_0_0_1, 0))
        self.connect((self.osmosdr_source_0, 0), (self.blocks_complex_to_mag_squared_0_0, 0))
        self.connect((self.osmosdr_source_0, 0), (self.blocks_complex_to_real_0_0, 0))
        self.connect((self.osmosdr_source_0, 0), (self.digital_ofdm_rx_0_0_0, 0))
...
def main(top_block_cls=ofdmreciever, options=None):
